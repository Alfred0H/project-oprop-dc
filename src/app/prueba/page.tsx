  ...
  return (
    <>
      ...
      <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
          <div>
            <h1 className="text-3xl font-extrabold">Let Talk</h1>
            <p className="text-sm text-gray-400 mt-3">Have some big idea or brand to develop and need help? Then reach out wed love to hear about your project  and provide help.</p>
            <div className="mt-12">
          ...
          <form action="https://fabform.io/f/xxxxx" method="post" className="ml-auo space-y-4">
            ...
            <textarea placeholder='Message' col-span-full
              name='message'
